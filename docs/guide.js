...
const fixedPlaceAddresses = {
  ...
  "할리스 부산송정점": "부산광역시 해운대구 송정동 443-5", "투썸플레이스 부산송정힐스점": "부산광역시 해운대구 송정동 446-2", "하삼동커피 송정점": "부산광역시 해운대구 송정중앙로 23", "카페리프": "부산광역시 해운대구 송정동 297-17", "인얼스커피 송정점": "부산광역시 해운대구 송정동 436-4", "더레스트마린": "부산광역시 해운대구 송정구덕포길 134",
...
const fixedPlaceCoordinates = {
  ...
  "하삼동커피 송정점": [35.1829854, 129.2028381], "더레스트마린": [35.1710663, 129.1975473], "스타벅스 해운대점": [35.1616735, 129.1603502], "산리오 러버스 클럽 해운대점": [35.1636139, 129.1565233], "로우앤스윗 해리단길점": [35.1648920, 129.1580299], "엣지993": [35.1578569, 129.1723282],
