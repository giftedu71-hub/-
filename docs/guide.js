...
function addRestaurantList() {
  ...
  const restaurantData = {
    ...
    "송도해수욕장": [["송도해솥", "한식", "전복솥밥, 해산물솥밥"], ["송도키친", "한식", "돼지국밥, 수육"], ["김형제고기의철학 부산송도점", "한식", "이베리코 숙성돼지고기"], ["속시원해대구탕 송도점", "한식", "대구탕, 대구뽈찜"], ["조새호오마카세", "일식", "스시 오마카세, 사시미"], ["왕밀면냉면", "한식", "밀면, 비빔밀면, 만두"], ["최진사댁", "한식", "조개구이, 해산물구이"]],
  };
  const restaurantLinks = {
    ...
    "송도해솥": "https://map.naver.com/p/search/송도해솥%20부산", "송도키친": "https://map.naver.com/p/search/송도키친%20부산", "김형제고기의철학 부산송도점": "https://map.naver.com/p/search/김형제고기의철학%20부산송도점", "속시원해대구탕 송도점": "https://map.naver.com/p/search/속시원해대구탕%20송도점", "조새호오마카세": "https://map.naver.com/p/search/조새호오마카세%20부산", "왕밀면냉면": "https://map.naver.com/p/search/왕밀면냉면%20부산%20송도", "최진사댁": "https://map.naver.com/p/search/최진사댁%20부산%20송도",
...
const fixedPlaceAddresses = {
  ...
  "송도해솥": "부산광역시 서구 송도해변로 133 4층", "송도키친": "부산광역시 서구 송도해변로 113 페어필드 바이 메리어트 부산 송도비치 22층", "조새호오마카세": "부산광역시 서구 송도해변로 10 4층 상월대", "왕밀면냉면": "부산광역시 서구 충무대로 122-1 프레스코 2층", "최진사댁": "부산광역시 서구 암남동 620-24", "송정집": "부산광역시 해운대구 송정동 437-9", "해운대31cm해물칼국수 송정본점": "부산광역시 해운대구 송정동 158-2", "송정가마솥돼지국밥": "부산광역시 해운대구 송정동 139-18", "다솥맛집 송정본점": "부산광역시 해운대구 송정동 313-10", "미포집 송정직영점": "부산광역시 해운대구 송정동 798-2", "낙불집 송정본점": "부산광역시 해운대구 송정동 442-5",
...
const fixedPlaceCoordinates = {
  ...
  "송정집": [35.17686779660262, 129.19681887567634], "해운대31cm해물칼국수 송정본점": [35.18167301453993, 129.2001405545811], "송정가마솥돼지국밥": [35.18205044454625, 129.20018413643209], "다솥맛집 송정본점": [35.178394652007505, 129.19793005574235], "미포집 송정직영점": [35.18478, 129.20236], "낙불집 송정본점": [35.18047, 129.19963],
  "할리스 부산송정점": [35.18076, 129.19986], "투썸플레이스 부산송정힐스점": [35.18132, 129.20013], "하삼동커피 송정점": [35.1829854, 129.2028381], "카페리프": [35.17683, 129.19935], "인얼스커피 송정점": [35.17743219558118, 129.1971820139762], "드래그하우스": [35.18038, 129.19976], "더레스트마린": [35.17930525147386, 129.20512698996163],
