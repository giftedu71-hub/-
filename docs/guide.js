...
function addRestaurantList() {
  ...
  const restaurantData = {
    ...
    "송도해수욕장": [["송도해솥", "한식", "전복솥밥, 해산물솥밥"], ["송도키친", "한식", "돼지국밥, 수육"], ["김형제고기의철학 부산송도점", "한식", "이베리코 숙성돼지고기"], ["우연지 부산송도점", "한식", "한우 모둠구이, 등심, 안심, 치마살"], ["상월대", "일식", "스시 오마카세, 사시미"], ["왕밀면냉면", "한식", "밀면, 비빔밀면, 만두"], ["최진사댁", "한식", "조개구이, 해산물구이"]],
  };
  const restaurantLinks = {
    ...
    "송도해솥": "https://map.naver.com/p/search/송도해솥%20부산", "송도키친": "https://map.naver.com/p/search/송도키친%20부산", "김형제고기의철학 부산송도점": "https://map.naver.com/p/search/김형제고기의철학%20부산송도점", "우연지 부산송도점": "https://map.naver.com/p/search/우연지%20부산송도점", "상월대": "https://map.naver.com/p/search/상월대%20부산%20송도", "왕밀면냉면": "https://map.naver.com/p/search/왕밀면냉면%20부산%20송도", "최진사댁": "https://map.naver.com/p/search/최진사댁%20부산%20송도",
...
const fixedPlaceAddresses = {
  ...
  "송도해솥": "부산광역시 서구 송도해변로 133 4층", "송도키친": "부산광역시 서구 송도해변로 113 페어필드 바이 메리어트 부산 송도비치 22층", "상월대": "부산광역시 서구 송도해변로 10 4층", "왕밀면냉면": "부산광역시 서구 충무대로 122-1 프레스코 2층", "최진사댁": "부산광역시 서구 암남동 620-24", "송정집": "부산광역시 해운대구 송정동 437-9", "해운대31cm해물칼국수 송정본점": "부산광역시 해운대구 송정동 158-2", "송정가마솥돼지국밥": "부산광역시 해운대구 송정동 139-18", "다솥맛집 송정본점": "부산광역시 해운대구 송정동 313-10", "미포집 송정직영점": "부산광역시 해운대구 송정동 798-2", "낙불집 송정본점": "부산광역시 해운대구 송정동 442-5",
...
const fixedPlaceCoordinates = {
  ...
  "송정물총칼국수": [35.17632166448883, 129.19665700194804], "송도키친": [35.07769298934426, 129.01926108157895], "김형제고기의철학 부산송도점": [35.075285711305895, 129.01602350688307], "우연지 부산송도점": [35.07385931499843, 129.0158679534335], "왕밀면냉면": [35.081292779105326, 129.0251035596277], "상월대": [35.070625920443895, 129.0186231337873],
  "할리스 부산송정점": [35.18076, 129.19986], "투썸플레이스 부산송정힐스점": [35.18132, 129.20013], "하삼동커피 송정점": [35.1829854, 129.2028381], "카페리프": [35.180837511596394, 129.20290904526888], "인얼스커피 송정점": [35.17743219558118, 129.1971820139762], "드래그하우스": [35.18038, 129.19976], "더레스트마린": [35.17930525147386, 129.20512698996163],
  "스타벅스 해운대점": [35.1616735, 129.1603502], "산리오 러버스 클럽 해운대점": [35.1636139, 129.1565233], "로우앤스윗 해리단길점": [35.1648920, 129.1580299], "엣지993": [35.1578569, 129.1723282],
